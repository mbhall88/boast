...
Worked examples for the shapes a Project usually takes, plus automating the whole thing
in CI.
...
- **[Automating snapshots in CI](./ci-snapshots.md)** — a copy-paste GitHub Actions
  workflow that runs `boast about` on a schedule and commits the growing history.
