...
databases, so you can make statements backed by evidence about a tool's impact — the kind
...
**Reports** for grant writing (terminal, Markdown, and an automatically written prose sentence).
